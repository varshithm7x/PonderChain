...
const ABI = [
  "function getPoll(uint256) view returns (tuple(uint256 id, address creator, string question, string[] options, uint256 rewardPool, uint256 startTime, uint256 endTime, bool isActive, bool rewardsDistributed, uint256 totalPredictions, uint256 winningOption, uint256[] optionVotes))",
  "function getActivePolls() view returns (tuple(uint256 id, address creator, string question, string[] options, uint256 rewardPool, uint256 startTime, uint256 endTime, bool isActive, bool rewardsDistributed, uint256 totalPredictions, uint256 winningOption, uint256[] optionVotes)[])",
